    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="liangcangId" name="liangcangId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="水稻种类" prop="renwuTypes">
                        <el-select v-model="ruleForm.renwuTypes" :disabled="ro.renwuTypes" placeholder="请选择水稻种类">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="水稻种类" prop="renwuValue">
                        <el-input v-model="ruleForm.renwuValue"
                            placeholder="水稻种类" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="出受量" prop="renwuXianyouNumber">
                       <el-input v-model="ruleForm.renwuXianyouNumber"
                                 placeholder="出受量" clearable  :readonly="ro.renwuXianyouNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="出受量" prop="renwuXianyouNumber">
                           <el-input v-model="ruleForm.renwuXianyouNumber"
                                     placeholder="出受量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="出粮收粮" prop="renwuShifouTypes">
                        <el-select v-model="ruleForm.renwuShifouTypes" :disabled="ro.renwuShifouTypes" placeholder="请选择出粮收粮">
                            <el-option
                                v-for="(item,index) in renwuShifouTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="出粮收粮" prop="renwuShifouValue">
                        <el-input v-model="ruleForm.renwuShifouValue"
                            placeholder="出粮收粮" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="价格" prop="renwuNewMoney">
                       <el-input v-model="ruleForm.renwuNewMoney"
                                 placeholder="价格" clearable  :readonly="ro.renwuNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="价格" prop="renwuNewMoney">
                           <el-input v-model="ruleForm.renwuNewMoney"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    liangcangId: false,
                    renwuTypes: false,
                    renwuXianyouNumber: false,
                    renwuShifouTypes: false,
                    renwuNewMoney: false,
                    renwuDelete: false,
                    insertTime: false,
                },
                ...
                rules: {
                   ...
                   renwuTypes: [
                              { required: true, message: '水稻种类不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   renwuXianyouNumber: [
                              { required: true, message: '出受量不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   renwuShifouTypes: [
                              { required: true, message: '出粮收粮不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=renwu_shifou_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.renwuShifouTypesOptions = data.data.list;
                    }
                });
